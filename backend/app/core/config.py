...
class Settings(BaseSettings):
    ...
    market_daily_bars_cache_ttl_seconds: int = Field(default=21600)
    market_intraday_bars_cache_ttl_seconds: int = Field(default=60)
    market_stale_bars_cache_ttl_seconds: int = Field(default=604800)
